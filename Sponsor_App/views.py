...
class SponsorHomePage(SuperAdminRequiredMixin, TemplateView):
...
class MySponsorshipPage(SuperAdminRequiredMixin, TemplateView):
    template_name = "my_sponsorship.html"
    login_url = "/login-page"
    redirect_field_name = "authentication_required"


class ReceivedMessages(SuperAdminRequiredMixin, TemplateView):
